...
public class SM3 {
    ...
    /**
     * iv： initial value <br/>
     * IV =7380166f 4914b2b9 172442d7 da8a0600 a96f30bc 163138aa e38dee4d b0fb0e4e <br/>
     * 初始值，用于确定压缩函数寄存器的初态
     */
    ...
    /**
     * 压缩函数 CF  执行迭代压缩 V(i+1） = CF( V(i), B(i));
     * @param V V(0) 为256比特初始值IV; V(i)为第i-1次压缩结果，用于第i轮迭代压缩入参
     * @param B 第i个消息分组
     * @return
     */
    ...
    /*
          消息扩展： 将消息分组B (i) 按以下方法扩展生成132个字W 0 ,W 1 ,···,W 67 ,W ′0 ,W′1 ,···,W′63 ， 用于压缩函数CF
           */
